...
The detail behind the [README](../../README.md): the full results table, how the evaluation
harness is built, what the ablation measured, and what the numbers do not mean.

Every figure here comes from one frozen run,
[`semantic-hybrid-rr-ctx-ag-final`](../../evals/results/semantic-hybrid-rr-ctx-ag-final.json),
over 202 questions and 248 gold spans.
