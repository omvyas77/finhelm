...
def test_markdown_headings_do_not_count_as_uncited_claims():
    """The first version of the metric counted every heading as an unsourced assertion, which made
...
def test_route_accuracy_gives_no_partial_credit_for_half_a_comparison():
    """A failure from the first evaluation: routed a comparative question to complaints only, then wrote a
