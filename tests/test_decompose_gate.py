...
def test_gate_fails_toward_not_splitting():
    ...
    guessing: a missed split costs the pre-decomposition behaviour, an unnecessary one costs latency
...
def test_decompose_passes_its_timeout_to_the_model_call(monkeypatch):
    """Config.agent_timeout_s was defined, was logged into every history row, and
