...
paragraph in notes/failures.md because the point of the taxonomy is to be re-run: the
retrieval work exists to move these counts, and a hand-tallied table would be stale the first time
retrieval changes.
