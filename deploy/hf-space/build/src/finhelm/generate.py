...
def answer(
    ...
    # retrieval and generation after the fact is miserable, and tracing needs it on every span.
    ...
    if not found.hits:
        ...
        # model declined to answer" distinguishable in the evaluation numbers. Collapsing them
